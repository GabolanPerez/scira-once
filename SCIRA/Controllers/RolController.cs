...
{
    [Authorize]
    [Access(Funcion = "Roles", ModuleCode = "MSICI000")]
    [CustomErrorHandler]
    public class RolController : Controller
    {
        ...
        {
            ViewBag.funciones = Utilidades.DropDown.FuncionesMS();
            return View();
        }
        ...
        public ActionResult Agregar([Bind(Include = "id_rol,cl_rol,nb_rol,id_funcion")] AgregarRolViewModel Rol)
        {
            ...
            ViewBag.funciones = Utilidades.DropDown.FuncionesMS(Rol.id_funcion);
            if (Rol.id_funcion == null)
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.funciones = Utilidades.DropDown.FuncionesMS(funciones);
            return View(rol);
        }
