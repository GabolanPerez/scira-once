...
namespace SCIRA.Controllers
{
    ...
    //[CustomErrorHandler]
    public class BDEIR2811Controller : Controller
    {
        private SICIEntities db = new SICIEntities();

        public ActionResult Index()
        {
            var model = db.kg_r2811;
        ...
        public ActionResult Generate(int periodo,int anno,int id_entidad)
        {
            ...
            db.genera_r2811(0, anno, periodo, user.Nb_usuario, id_entidad);
        ...
        public ActionResult ReGenerate(int id)
        {
            ...
            db.genera_r2811(id, 0, 0, user.Nb_usuario,0);
