...
{
    [Authorize]
    [Access(Funcion = "FrecuenciaControl", ModuleCode = "MSICI003")]
    [CustomErrorHandler]
    public class FrecuenciaControlController : Controller
    {
        ...
        {
            return View(db.c_frecuencia_control.ToList());
        }

        // GET: FrecuenciaControl/Details/5
        public ActionResult Details(int? id)
        {
            ...
            c_frecuencia_control c_frecuencia_control = db.c_frecuencia_control.Find(id);
            if (c_frecuencia_control == null)
            {
                return HttpNotFound();
            }
            return View(c_frecuencia_control);
        }

        // GET: FrecuenciaControl/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: FrecuenciaControl/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Create([Bind(Include = "id_frecuencia_control,cl_frecuencia_control,nb_frecuencia_control")] c_frecuencia_control c_frecuencia_control)
        {
            if (ModelState.IsValid)
            {
                db.c_frecuencia_control.Add(c_frecuencia_control);
                db.SaveChanges();
        ...
        // POST: FrecuenciaControl/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Edit([Bind(Include = "id_frecuencia_control,cl_frecuencia_control,nb_frecuencia_control")] c_frecuencia_control c_frecuencia_control)
        {
            if (ModelState.IsValid)
            {
                db.Entry(c_frecuencia_control).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(c_frecuencia_control);
        ...
        // GET: FrecuenciaControl/Delete/5
        public ActionResult Delete(int? id, string redirect = null)
        {
            ...
            ViewBag.RR = RR;
            if (c_frecuencia_control.r_control.Count() > 0) ViewBag.LinkedToR = true;
            return View(c_frecuencia_control);
        }

        // POST: FrecuenciaControl/Delete/5
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            Utilidades.DeleteActions.DeleteFrecuenciaControlObjects(c_frecuencia_control, db);
            db.c_frecuencia_control.Remove(c_frecuencia_control);
            try
            {
                db.SaveChanges();
            }
