...
{
    [Authorize]
    [Access(Funcion = "NaturalezaControl", ModuleCode = "MSICI003")]
    [CustomErrorHandler]
    public class NaturalezaControlController : Controller
    {
        private SICIEntities db = new SICIEntities();

        // GET: NaturalezaControl
        public ActionResult Index()
        {
            return View(db.c_naturaleza_control.ToList());
        }

        // GET: NaturalezaControl/Details/5
        public ActionResult Details(int? id)
        {
            ...
            c_naturaleza_control c_naturaleza_control = db.c_naturaleza_control.Find(id);
            if (c_naturaleza_control == null)
            {
                return HttpNotFound();
            }
            return View(c_naturaleza_control);
        }

        // GET: NaturalezaControl/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NaturalezaControl/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Create([Bind(Include = "id_naturaleza_control,cl_naturaleza_control,nb_naturaleza_control")] c_naturaleza_control c_naturaleza_control)
        {
            if (ModelState.IsValid)
            {
                db.c_naturaleza_control.Add(c_naturaleza_control);
                db.SaveChanges();
        ...
        // POST: NaturalezaControl/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Edit([Bind(Include = "id_naturaleza_control,cl_naturaleza_control,nb_naturaleza_control")] c_naturaleza_control c_naturaleza_control)
        {
            if (ModelState.IsValid)
            {
                db.Entry(c_naturaleza_control).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(c_naturaleza_control);
        ...
        // GET: NaturalezaControl/Delete/5
        public ActionResult Delete(int? id, string redirect = null)
        {
            ...
            var r_control = db.k_control.Where(b => b.id_frecuencia_control == id).ToList();
            ...
            ViewBag.RR = RR;
            if (c_naturaleza_control.r_control.Count() > 0) ViewBag.LinkedToR = true;
            return View(c_naturaleza_control);
        }

        // POST: NaturalezaControl/Delete/5
        ...
        {
            c_naturaleza_control c_naturaleza_control = db.c_naturaleza_control.Find(id);
            Utilidades.DeleteActions.DeleteNaturalezaControlObjects(c_naturaleza_control, db);

            db.c_naturaleza_control.Remove(c_naturaleza_control);
            try
            {
                db.SaveChanges();
            }
