...
{
    [Authorize]
    [Access(Funcion = "GradoCobertura", ModuleCode = "MSICI003")]
    [CustomErrorHandler]
    public class GradoCoberturaController : Controller
    {
        ...
        {
            return View(db.c_grado_cobertura.ToList());
        }

        // GET: GradoCobertura/Details/5
        public ActionResult Details(int? id)
        {
            ...
            c_grado_cobertura c_grado_cobertura = db.c_grado_cobertura.Find(id);
            if (c_grado_cobertura == null)
            {
                return HttpNotFound();
            }
            return View(c_grado_cobertura);
        }

        // GET: GradoCobertura/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: GradoCobertura/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Create([Bind(Include = "id_grado_cobertura,cl_grado_cobertura,nb_grado_cobertura")] c_grado_cobertura c_grado_cobertura)
        {
            if (ModelState.IsValid)
            {
                db.c_grado_cobertura.Add(c_grado_cobertura);
                db.SaveChanges();
        ...
        // POST: GradoCobertura/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Edit([Bind(Include = "id_grado_cobertura,cl_grado_cobertura,nb_grado_cobertura")] c_grado_cobertura c_grado_cobertura)
        {
            if (ModelState.IsValid)
            {
                db.Entry(c_grado_cobertura).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(c_grado_cobertura);
        ...
        public ActionResult Delete(int? id, string redirect = null)
        {
            ...
            var r_control = db.k_control.Where(b => b.id_grado_cobertura == id).ToList();
            ...
            ViewBag.RR = RR;
            if (c_grado_cobertura.r_control.Count() > 0) ViewBag.LinkedToR = true;

            return View(c_grado_cobertura);
        }

        // POST: GradoCobertura/Delete/5
        ...
        {
            c_grado_cobertura c_grado_cobertura = db.c_grado_cobertura.Find(id);
            Utilidades.DeleteActions.DeleteGradoCoberturaObjects(c_grado_cobertura, db);
            db.c_grado_cobertura.Remove(c_grado_cobertura);
            try
            {
                db.SaveChanges();
            }
