...
{
    [Authorize]
    [Access(Funcion = "ImpactoRO", ModuleCode = "MSICI005")]
    [CustomErrorHandler]
    public class ImpactoRiesgoOperacionalController : Controller
    {
        private SICIEntities db = new SICIEntities();

        // GET: ImpactoRiesgoOperacional
        public ActionResult Index()
        {
            return View(db.c_impacto_riesgo_operacional.Where(r => r.esta_activo ?? false).ToList());
        }

        #region Create
        // GET: ImpactoRiesgoOperacional/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ImpactoRiesgoOperacional/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Create(c_impacto_riesgo_operacional c_impacto_riesgo_operacional)
        {
            if (ModelState.IsValid)
            {
                c_impacto_riesgo_operacional.esta_activo = true;
                db.c_impacto_riesgo_operacional.Add(c_impacto_riesgo_operacional);
                db.SaveChanges();

                //crear criticidades
                Utilidades.Utilidades.ValidateCRR();
                var frecuencias= db.c_frecuencia_riesgo_operacional.ToList();
                foreach (var frecuencia in frecuencias)
                {
                    var criticidad = new c_criticidad_ro
                    {
                        id_frecuencia_riesgo_operacional = frecuencia.id_frecuencia_riesgo_operacional,
                        id_impacto_riesgo_operacional = c_impacto_riesgo_operacional.id_impacto_riesgo_operacional,
            ...
            return View(c_impacto_riesgo_operacional);
        }
        #endregion

        #region Edit
        // GET: ImpactoRiesgoOperacional/Edit/5
        public ActionResult Edit(int? id)
        {
            ...
            c_impacto_riesgo_operacional c_impacto_riesgo_operacional = db.c_impacto_riesgo_operacional.Find(id);
            if (c_impacto_riesgo_operacional == null)
            {
                return HttpNotFound();
            }
            return View(c_impacto_riesgo_operacional);
        ...
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Edit(c_impacto_riesgo_operacional c_impacto_riesgo_operacional)
        {
            if (ModelState.IsValid)
            {
                c_impacto_riesgo_operacional.esta_activo = true;
                db.Entry(c_impacto_riesgo_operacional).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(c_impacto_riesgo_operacional);
        ...
        #region Delete
        // GET: ImpactoRiesgoOperacional/Delete/5
        ...
        // POST: ImpactoRiesgoOperacional/Delete/5
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //Utilidades.DeleteActions.DeleteImpactoROObjects(c_impacto_riesgo_operacional, db);
            c_impacto_riesgo_operacional.esta_activo = false;
            try
            {
                db.SaveChanges();
            }
