...
{
    [Authorize]
    [Access(Funcion = "CategoriaControl", ModuleCode = "MSICI003")]
    [CustomErrorHandler]
    public class CategoriaControlController : Controller
    {
        ...
        {
            return View(db.c_categoria_control.ToList());
        }

        // GET: CategoriaControl/Details/5
        public ActionResult Details(int? id)
        {
            ...
            c_categoria_control c_categoria_control = db.c_categoria_control.Find(id);
            if (c_categoria_control == null)
            {
                return HttpNotFound();
            }
            return View(c_categoria_control);
        }

        // GET: CategoriaControl/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CategoriaControl/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Create([Bind(Include = "id_categoria_control,cl_categoria_control,nb_categoria_control")] c_categoria_control c_categoria_control)
        {
            if (ModelState.IsValid)
            {
                db.c_categoria_control.Add(c_categoria_control);
                db.SaveChanges();
        ...
        // POST: CategoriaControl/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Edit([Bind(Include = "id_categoria_control,cl_categoria_control,nb_categoria_control")] c_categoria_control c_categoria_control)
        {
            if (ModelState.IsValid)
            {
                db.Entry(c_categoria_control).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(c_categoria_control);
        ...
        public ActionResult Delete(int? id, string redirect = null)
        {
            ...
            var r_control = db.k_control.Where(b => b.id_categoria_control == id).ToList();
            ...
            ViewBag.RR = RR;
            if (c_categoria_control.r_control.Count() > 0) ViewBag.LinkedToR = true;

            return View(c_categoria_control);
        }

        // POST: CategoriaControl/Delete/5
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            Utilidades.DeleteActions.DeleteCategoriaControlObjects(c_categoria_control, db);
            db.c_categoria_control.Remove(c_categoria_control);
            try
            {
                db.SaveChanges();
            }
