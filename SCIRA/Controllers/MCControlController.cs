...
{
    [Authorize]
    [Access(Funcion = "MCControl", ModuleCode = "MSICI003")]
    [CustomErrorHandler]
    public class MCControlController : Controller
    {
        ...
        {
            var c_meta_campo = Utilidades.Utilidades.infoCamposExtra("k_control", 20);
