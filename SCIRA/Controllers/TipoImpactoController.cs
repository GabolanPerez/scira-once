...
{
    [Authorize]
    [Access(Funcion = "TipoImpacto", ModuleCode = "MSICI003")]
    [CustomErrorHandler]
    public class TipoImpactoController : Controller
    {
        ...
        {
            return View(db.c_tipo_impacto.ToList());
        }

        // GET: TipoImpacto/Details/5
        public ActionResult Details(int? id)
        {
            ...
            c_tipo_impacto c_tipo_impacto = db.c_tipo_impacto.Find(id);
            if (c_tipo_impacto == null)
            {
                return HttpNotFound();
            }
            return View(c_tipo_impacto);
        }

        // GET: TipoImpacto/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TipoImpacto/Create
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Create([Bind(Include = "id_tipo_impacto,cl_tipo_impacto,nb_tipo_impacto")] c_tipo_impacto c_tipo_impacto)
        {
            if (ModelState.IsValid)
            {
                db.c_tipo_impacto.Add(c_tipo_impacto);
                db.SaveChanges();
        ...
        // POST: TipoImpacto/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que desea enlazarse. Para obtener 
        // más información vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        [NotOnlyRead]
        public ActionResult Edit([Bind(Include = "id_tipo_impacto,cl_tipo_impacto,nb_tipo_impacto")] c_tipo_impacto c_tipo_impacto)
        {
            if (ModelState.IsValid)
            {
                db.Entry(c_tipo_impacto).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(c_tipo_impacto);
        ...
        public ActionResult Delete(int? id, string redirect = null)
        {
            ...
            var r_riesgo = db.k_riesgo.Where(b => b.id_tipo_impacto == id).ToList();
            ...
            ViewBag.RR = RR;
            if (c_tipo_impacto.r_riesgo.Count() > 0) ViewBag.LinkedToR = true;
            return View(c_tipo_impacto);
        }

        // POST: TipoImpacto/Delete/5
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            Utilidades.DeleteActions.DeleteTipoImpactoObjects(c_tipo_impacto, db);
            db.c_tipo_impacto.Remove(c_tipo_impacto);
            try
            {
                db.SaveChanges();
            }
