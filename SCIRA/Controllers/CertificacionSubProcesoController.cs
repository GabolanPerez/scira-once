...
{
    [Authorize]
    [Access(Funcion = "CertificacionSP", ModuleCode = "MSICI004")]
    [CustomErrorHandler]
    public class CertificacionSubProcesoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //regresa las subProcesos pro  tramo de control
            var subProcesos = Utilidades.Utilidades.RTCObject(us, db, "c_sub_proceso").Cast<c_sub_proceso>().OrderBy(x => x.cl_sub_proceso).ToList();
        ...
        public ActionResult Certificados(int? id)
        {
            ...
            var controles = c_sub_proceso.k_control;
            bool puedeCertificar = true;
            var noCTR = controles.Count();
            var noCTRC = 0; //Número de macroprocesos certificados

            if (c_periodo_certificacion != null)
            {
                //Encontrar cuantos controles están certificados en el periodo actual
                foreach (var ctr in controles)
                {
                    if (ctr.k_certificacion_control.Any(c => c.id_periodo_certificacion == c_periodo_certificacion.id_periodo_certificacion) || ctr.tiene_accion_correctora)
                        noCTRC++;
                }
            }
            ...
            if (CertificacionSegura)
            {
                ...
                puedeCertificar = noCTR == noCTRC;
            }

            puedeCertificar = puedeCertificar && c_periodo_certificacion != null;

            ViewBag.ctrc = noCTRC; //controles certificados
            ViewBag.ctrnc = noCTR - noCTRC; //controles no certificados
            ...
            return View(c_sub_proceso.k_certificacion_estructura);
        }
        #endregion
        ...
        public ActionResult Certificar(int? id)
        {
            ...
            if (c_periodo_certificacion != null)
            {
                ...
                foreach (var ctr in controles)
                {
                    if (ctr.k_certificacion_control.Any(c => c.id_periodo_certificacion == c_periodo_certificacion.id_periodo_certificacion))
                        noCTRC++;
                }
            ...
            model.id_sub_proceso = id;
            model.id_periodo_certificacion = c_periodo_certificacion.id_periodo_certificacion;
            model.leyenda_certificacion_estructura = Utilidades.Utilidades.GetSecurityProp("LeyendaCS", "Me he asegurado que los controles que mitigan " +
        ...
        public ActionResult Certificar(k_certificacion_estructura model, int[] files)
        {
            ...
            {
                model.cl_certificacion_estructura = "S";
                ...
                var reg = db.c_sub_proceso.Find(model.id_sub_proceso);
                Utilidades.Utilidades.refreshNotifCount(reg.id_responsable);
                Utilidades.Utilidades.removeRow(12, model.id_sub_proceso ?? 0, reg.id_responsable);

                return RedirectToAction("Certificados", new { id = model.id_sub_proceso });
            }
            ...
            ViewBag.SP = db.c_sub_proceso.Find(model.id_sub_proceso);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            if (c_periodo_certificacion != null)
            {
                if (k_certificacion_estructura.id_periodo_certificacion != c_periodo_certificacion.id_periodo_certificacion)
                    return RedirectToAction("Certificados", new { id = k_certificacion_estructura.id_sub_proceso });
            }
            else
            {
                return RedirectToAction("Certificados", new { id = k_certificacion_estructura.id_sub_proceso });
            ...
            ViewBag.SP = k_certificacion_estructura.c_sub_proceso;
        ...
        public ActionResult Edit(k_certificacion_estructura model, int[] files)
        {
            ...
            var periodo = db.c_periodo_certificacion.Find(model.id_periodo_certificacion);
            var SP = db.c_sub_proceso.Find(model.id_sub_proceso);
            ViewBag.nb_periodo_certificacion = periodo.nb_periodo_certificacion + " - " + periodo.anio; ;
            ViewBag.SP = SP;
        ...
        {
            k_certificacion_estructura k_certificacion_estructura = db.k_certificacion_estructura.Find(id);
            var id_sub_proceso = k_certificacion_estructura.id_sub_proceso;
            ...
            try
            {
                ns = (int)HttpContext.Session["JuctrCounter"];
            }
            catch
            {
                ns = 0;
            ...
            if (ns == 0)
            {
                return RedirectToAction("Certificados", new { id = id_sub_proceso });
            ...
            else
            {
                ...
                else
                {
                    ...
                    HttpContext.Session["JuctrCounter"] = ns;
        ...
        #region Info
        public ActionResult ctrc(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            ...
            return PartialView("DetailViews/DetailsCTR", ctrc);
        }


        public ActionResult ctrnc(int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            ...
            List<k_control> ctrnc = controles.ToList();
            ...
            return PartialView("DetailViews/DetailsCTR", ctrnc);
        }
        #endregion
