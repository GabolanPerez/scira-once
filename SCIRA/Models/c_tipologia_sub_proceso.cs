...
namespace SCIRA.Models
{
    ...
    public partial class c_tipologia_sub_proceso
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public c_tipologia_sub_proceso()
        {
            this.c_sub_proceso = new HashSet<c_sub_proceso>();
        }

        public int id_tipologia_sub_proceso { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "LineaNegocioCreate001")]
        [StringLength(20, ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "Longitud20")]
        public string cl_tipologia_sub_proceso { get; set; }
        ...
        public string nb_tipologia_sub_proceso { get; set; }
