...
namespace SCIRA.Models
{
    ...
    public partial class c_division_auditoria
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public c_division_auditoria()
        {
            this.c_auditoria = new HashSet<c_auditoria>();
            this.c_usuario = new HashSet<c_usuario>();
        }
    
        public int id_division_auditoria { get; set; }
