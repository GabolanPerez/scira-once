...
namespace SCIRA.Models
{
    ...
    public partial class c_tipo_normatividad
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public c_tipo_normatividad()
        {
            this.c_normatividad = new HashSet<c_normatividad>();
        }

        public int id_tipo_normatividad { get; set; }
        ...
        public string cl_tipo_normatividad { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "Validacion001")]
        [StringLength(256, ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "Longitud256")]
        public string nb_tipo_normatividad { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<c_normatividad> c_normatividad { get; set; }
    }
}
